...
router.post('/',verifyToken,[body('name').not().isEmpty(),body('email').not().isEmpty().isEmail(),body('reg_num').not().isEmpty(),body('dept').not().isEmpty(),body('cgpa').not().isString().isEmpty(),body('ten_mark').not().isEmpty(),body('ten_board').not().isEmpty(),body('twelve_mark').not().isEmpty(),body('twelve_board').not().isEmpty()],async(req,res)=>{
